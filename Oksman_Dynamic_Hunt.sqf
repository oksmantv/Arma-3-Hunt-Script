...
Code to Launch:
null = [ENEMYFACTION,MINRANGE,MAXANGE] execVM "OKS_HUNT\Oksman_Dynamic_Hunt.sqf";

Example:
null = [EAST,1000,2000] execVM "OKS_HUNT\Oksman_Dynamic_Hunt.sqf";
*/
...
_null = [OKS_EnemyFaction] execVM "OKS_Hunt\Oksman_Hunt_Radio.sqf";
...
OKS_Hunting =
{
		...
		if ((_Hunter getVariable["isHunting",false]) && !(_Hunter getVariable["isTracking",false])) then
		{
			...
			null = [_Hunter,_nearestPlayer] execVM "OKS_HUNT\Oksman_Dynamic_Track.sqf";
		};
